...
python FedAverage.py --data='cifar10' --nclient=10 --nclass=10 --ncpc=10 --model='MobileNetV3Small' --mode='LDP' --round=20 --epsilon=2 --sr=1 --lr=5e-2 --flr=1e-1 --physical_bs=3 --E=1
